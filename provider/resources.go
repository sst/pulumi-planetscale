...
import (
	...
	planetscale "github.com/sst/terraform-provider-planetscale/provider"
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-planetscale/provider".New
		...
		//
		//nolint:lll
		P: pfbridge.ShimProvider(planetscale.New(version.Version, false)()),
		...
		Keywords:   []string{"sst-provider", "planetscale", "category/cloud"},
		License:    "Apache-2.0",
		...
		JavaScript: &tfbridge.JavaScriptInfo{
			PackageName: "@sst-provider/planetscale",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/sst/pulumi-planetscale/sdk/",
